...
import  com.yangonion.jsoup.util.JsoupUtil;
...
public class XssHttpServletRequestWrapper extends HttpServletRequestWrapper {
    ...
    public XssHttpServletRequestWrapper(HttpServletRequest servletRequest,boolean isIncludeRichText){
    ...
    public static HttpServletRequest getOrgRequest(HttpServletRequest req) {
        if (req instanceof XssHttpServletRequestWrapper) {
            return ((XssHttpServletRequestWrapper) req).getServletRequest();
        }
        return req;
    }
}
